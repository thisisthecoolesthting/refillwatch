/**
 * Topic-aware Amazon pick sets for RefillWatch articles.
...
const PICK = {
  ...
  ethiqueShampoo: {
    ...
    cardTitle: 'Ethique Eco-Friendly Shampoo Bar',
  ...
  hibarShampooSet: {
    ...
    cardTitle: 'HiBAR Solid Shampoo + Conditioner Set',
  ...
  ethiqueConditioner: {
    ...
    cardTitle: 'Ethique Conditioner Bar',
  ...
  georganicsPaste: {
    ...
    cardTitle: 'Georganics Natural Toothpaste',
    cardPick: 'Glass-jar paste you can refill—cuts tube waste without sacrificing clean ingredients.',
  },
  bambooBrush: {
    asin: 'B07NM4ZM3Z',
    title: 'Bamboo Switch Biodegradable Toothbrush',
    desc: 'BPA-free charcoal-infused bristles, 100% biodegradable bamboo handle—pack of 4.',
  ...
  beesWrap: {
    asin: 'B00YBXVLWK',
    title: "Bee's Wrap Organic Cotton Food Wrap Set",
    desc: 'Beeswax + organic cotton keeps food fresh, replaces cling film, compostable end-of-life.',
    cardTitle: "Bee's Wrap Organic Cotton Food Wrap Set",
